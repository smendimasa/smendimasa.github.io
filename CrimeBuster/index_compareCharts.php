...
function hs_updateBarGraph_percent(Data, bCType){
  ...
  },
  {
	...
	if(bCType=="districtBC"){
		...
		Highcharts.chart('chart_percent2', {
		  chart: {
		    type: 'column'
		  },
		  title: {
...
//function to be used when doing comparation for charts
function updateInnerCharts(clicked_id){
...
function toggleCompareView(clicked_id){
	console.log(clicked_id);
	
	if(clicked_id=="chart_percent_compare"){
		var btnVal =document.getElementById(clicked_id).innerHTML;
		if(btnVal=="Compare - On"){
			document.getElementById("leftDiv_chart_percent").style.width="100%";
			document.getElementById("rightDiv_chart_percent").style.width="0%";
			hideElt('rightDiv_chart_percent');
			hideElt('leftDiv_chart_percent');
			showElt('leftDiv_chart_percent');
			document.getElementById(clicked_id).innerHTML = "Compare - Off";
		}
		else{
			document.getElementById("leftDiv_chart_percent").style.width="48%";
			document.getElementById("rightDiv_chart_percent").style.width="48%";
			showElt('rightDiv_chart_percent');
			document.getElementById(clicked_id).innerHTML = "Compare - On";
		}
	}
...
<div class="w3-panel" id="barChartPanel">
    ...
    <div id="chart_percentPanel" style="width:100%">
    	<br>
    	
    	<div id="leftDiv_chart_percent" style="float:left; width:48%">
    	<span style="text-align: center"> Inner Category Filter </span>
    	<select id='percentBChartLeft' name='barChartX' onchange="updateInnerCharts(id);">
		    <!--  <option value="" selected='selected'>Please select an option</option> -->
		      <option value="crime_Type_barChart" >Crime Type</option>
          <option value="weapon_Type_barChart" >Weapon Type</option>
        <option value="district_Type_barChart">District</option> </select>
        	 &nbsp&nbsp
		   <button id="chart_percent_compare" onClick="toggleCompareView(id)">Compare - On</button> <hr>
    	<div id="chart_percent"></div>
    	</div>
    	
    	<div id="rightDiv_chart_percent" style="float:right; width:48%">
    		<span style="text-align: center"> Inner Category Filter </span>
    	<select id='percentBChartRight' name='barChartX' onchange="updateInnerCharts(id);">
		    <!--  <option value="" selected='selected'>Please select an option</option> -->
		      <option value="crime_Type_barChart" >Crime Type</option>
          <option value="weapon_Type_barChart" >Weapon Type</option>
        <option value="district_Type_barChart">District</option> </select> <hr>
    	<div id="chart_percent2"></div>
    </div>
    	
    	<br> <hr>
    </div>
    
    <div class="w3-panel" id="chart_highChartPanel">
    	<br><br>
    	<div id="chart_highChart"></div>
    </div>
    
    <div class="w3-panel" id="chart_highChart_stackPanel">
    	<br><br>
